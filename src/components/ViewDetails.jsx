...
//ViewDetails component to display detailed information about a book
function ViewDetails()
{
     const {bookname,bookauthor} = useParams();
     const navigate=useNavigate();
  const location = useLocation();
  const { description, image,rating} = location.state || {};
    return(
<div>
    ...
    <div>
           ...
           <div className="">
            ...
            <div className="w-[70vw] m-10 p-5 pt-0">
                ...
                <div className="flex justify-between w-[70%]">
                    <h2 className="text-xl m-1 text-blue-200">by {bookauthor}</h2>
     ...
     hover:text-gray-200 hover:bg-blue-700 text-white font-semibold '>Buy Now</button>
                ...
                <h2 className="text-lg m-1 text-green-200"> Rating: ⭐{rating}⭐  </h2>
                <br />
                <p>About:</p>
                <br />
